#!/usr/bin/env python3
"""Train a VAE on MNIST or Fashion-MNIST.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Override latent_dim from config (for sweep experiments)",
    )
    ...
    # Override latent_dim if provided via CLI
    ...
    print(f"{'='*50}")
    print(f"  Model:     VAE(latent_dim={m_cfg['latent_dim']})")
